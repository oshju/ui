...
class lodeo extends StatelessWidget {
  Future<void> fetchFiles() async {
    ...
    if (tknResp!= null) {
      var url =
          await http.post(Uri.https('api.spotify.com', '/v1/playlists/)', {
        'headers': {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: SafeArea(
          child: ListView(
        children: <Widget>[boton(),contendio()],
      )),
    );
  }
}
...
Widget contendio() {
  ...
  return Row(
    ...
    children: [
      Image.network('https://th.bing.com/th/id/OIP._uAASqISQzttbkhXrJWCXAHaD4?w=296&h=180&c=7&r=0&o=5&pid=1.7',
